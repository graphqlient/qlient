...
from qlient.core.models import Field, Fields, GraphQLRequest, PreparedFields, auto
from qlient.core.schema.models import Field as SchemaField
from qlient.core.schema.models import Input as SchemaInput
...
_AnyField = Union[Fields, Field, Iterable[Union[Field, str]], list[Union[Field, str]], None]
...
class RequestBuilder:
    ...
    def __init__(
        ...
        self.operation_inputs: dict[str, SchemaInput] = self.operation_field.arg_name_to_arg
        self.operation_output: SchemaType = schema.types_registry[self.operation_field.output_type_name]
    ...
    def build(self) -> GraphQLRequest:
        ...
        if _operation_variables is not None:
            query_builder.operation(self.operation_type, self.operation_name, _operation_variables)
