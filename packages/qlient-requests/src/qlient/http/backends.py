...
class HTTPBackend(Backend):
    ...
    def execute_subscription(self, request: GraphQLSubscriptionRequest) -> GraphQLResponse:
        ...
        # initiate connection
        logger.debug("Sending initiation payload")
        ...
        logger.debug("Connection acknowledged, starting subscription.")
